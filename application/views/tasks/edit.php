                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                                ...
                                <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                    <form class="form-horizontal" action="/tasks/update" method="POST">
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8" id="the-basics">
                                                    <label></label>
                                                    <input type="text" name="name" id="itask" value="<?php echo $obj->name;?>" />
                                                </div>
                                            </div>
                                            <div class="form-group has-warning">
                                                <label class="col-lg-4 control-label" for="inputError">Keterangan</label>
                                                <div class="col-lg-8">
                                                    <textarea name="description"  ><?php echo $obj->description;?></textarea>
                                                </div>
                                            </div>
